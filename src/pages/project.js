...
function Project() {
 ...
 return (
  ...
  <div className="text flex justify-center"> <h1 className="mx-20 mt-10 text-4xl  ">Graphic Design</h1></div>
  <ContentComponent thumbnailUrl1="/images/graphic1.jpg" thumbnailUrl2="/images/graphic2.jpg"/>
  
  <div className="flex justify-center"> <h1 className="mx-20 mt-10 text-4xl">3d</h1></div>
  <ContentComponent thumbnailUrl1="/images/3d1.jpg" thumbnailUrl2="/images/3d2.jpg"/>

  <div className="flex justify-center"> <h1 className="mx-20 mt-10 text-4xl">Web Design</h1></div>
  <ContentComponent thumbnailUrl1="/images/webdesign1.jpg" thumbnailUrl2="/images/webdesign2.jpg"/>

  <div className="flex justify-center"> <h1 className="mx-20 mt-10 text-4xl">App Design</h1></div>
  <ContentComponent thumbnailUrl1="/images/appdesign1.jpg" thumbnailUrl2="/images/appdesign2.jpg"/>

  <div className="flex justify-center"> <h1 className="mx-20 mt-10 text-4xl">Front-end Develop</h1></div>
